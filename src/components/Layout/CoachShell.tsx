...
export default function CoachShell({ children, title }: CoachShellProps) {
  ...
  const menuItems = [
    { label: 'Dashboard', path: '/Coach-Dashboard', icon: <Grid size={18} /> },
    { label: 'Scheduler', path: '/Schedule', icon: <CalendarCheck size={18} /> },
    { label: 'Analytics', path: '/Coach-Analytics', icon: <BarChart size={18} /> },
    { label: 'Profile', path: '/Coach-Profile', icon: <Person size={18} /> },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
      ...
      >
        <div className="h-16 flex items-center px-8 border-b border-gray-50">
          <span className="text-xl font-bold tracking-tight text-indigo-600">CoachPro</span>
        </div>
