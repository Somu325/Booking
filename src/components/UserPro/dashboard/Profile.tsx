...
//                      />
//                     {phoneError && <Typography color="danger">{phoneError}</Typography>}
//                     <Button   sx={{width:'80px' ,alignItems:'center'}} onClick={updateUserData} disabled={!!nameError || !!phoneError}>Update Profile</Button>
//                   </Box>
//                 ) : (
//                   <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
//                     <Typography>
...
//                       <strong>Phone Number:</strong> {userData?.mobileNumber}
//                     </Typography>
//                     <Button  sx={{width:'80px' ,alignItems:'center'}} onClick={() => setIsEditMode(true)}>Edit Profile</Button>
//                   </Box>
//                 )}
//               </CardContent>
//             </Card>
      ...
      <CssVarsProvider theme={theme}>
        ...
        >
          <Button
            variant="outlined"
            onClick={() => navigate('/screen')}
            sx={{ mb: 2 ,backgroundColor:'#0B6BCB',color: 'white', '&:hover': {
