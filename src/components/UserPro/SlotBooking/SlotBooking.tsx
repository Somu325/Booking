        ...
        >
          ...
          {coachDetails ? (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Typography><strong>Age:</strong> {coachDetails.age}</Typography>
      ...
      >
        ...
        >
          ...
          <Typography component="h2" id="subuser-modal-title" level="h4" textColor="inherit" fontWeight="lg" mb={2}>
            Select Subusers for  Booking
          </Typography>

          {subsets.length > 0 ? (
            <>
              <Typography id="subuser-modal-desc" textColor="text.tertiary" mb={2}>
                You can select up to two subusers for this booking.
              </Typography>
              <Select
            ...
            <Typography>No subusers available.</Typography>
          )}
        </Sheet>
      </Modal>
    </CssVarsProvider>
...
// import Option from '@mui/joy/Option'
// import CircularProgress from '@mui/joy/CircularProgress'
// import { ArrowBack, AccessTime, Person, Info, Group } from '@mui/icons-material'
// import { useParams, useNavigate, useLocation } from 'react-router-dom'
// import { Domain_URL } from '../config'
...
//   const [selectedSubuser1, setSelectedSubuser1] = useState<string>('')
//   const [selectedSlotId, setSelectedSlotId] = useState<string | null>(null)
//   const [bookingType, setBookingType] = useState<'single' | 'group' | null>(null)
//   const [groupSubusers, setGroupSubusers] = useState<string[]>([])
...
//   const handleBookingTypeSelect = (type: 'single' | 'group') => {
//     setBookingType(type)
//     setIsSubsetModalOpen(true)
//   }
...
//         data = {
//           userId,
//           childIds: groupSubusers.filter(id => id !== ''),
//           coachId,
//           slotId: selectedSlot.slotId,
//           bookingType: "group",
//           status: "available"
...
//           {!bookingType ? (
//             <>
//               <Typography component="h2" id="booking-modal-title" level="h4" textColor="inherit" fontWeight="lg" mb={2}>
//                 Select Booking Type
//               </Typography>
...
//             <>
//               <Typography component="h2" id="booking-modal-title" level="h4" textColor="inherit" fontWeight="lg" mb={2}>
//                 {bookingType === 'single' ? 'Single Booking' : 'Group Booking'}
//               </Typography>
//               {subsets.length > 0 ? (
//                 <>
//                   <Typography id="booking-modal-desc" textColor="text.tertiary" mb={2}>
//                     {bookingType === 'single' 
//                       ? 'Select a subuser for this booking.' 
//                       : 'Select up to 3 subusers for this group booking.'}
//                   </Typography>
//                   {bookingType === 'single' ? (
//                     <Select
...
//                       <Select
//                         key={index}
//                         placeholder={`Select subuser ${index + 1}`}
//                         value={groupSubusers[index] || ''}
//                         onChange={(_, newValue) => {
//                           const newGroupSubusers = [...groupSubusers]
//                           newGroupSubusers[index] = newValue as string
//                           setGroupSubusers(newGroupSubusers)
//                         }}
//                         sx={{ mb: 2 }}
//                         disabled={index > 0 && !groupSubusers[index - 1]}
//                       >
//                         {subsets.map((s) => (
